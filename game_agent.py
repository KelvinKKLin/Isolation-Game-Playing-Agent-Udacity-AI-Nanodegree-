...
def custom_score_3(game, player, params):
    ...
    #improve performance.
    score = (c1*custom_score(game,player)) + (c2*all_three_equal(game,player)) + (c3*improved_score(game, player)) + (c4*open_move_score(game, player)) + (c5*center_score(game,player))
    return score
